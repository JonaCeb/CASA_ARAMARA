    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-10">
          <a
            href="tel:3316057476"
            className="px-8 py-4 bg-kaleo-terracotta text-kaleo-cream font-body text-sm uppercase tracking-wider rounded-full hover:bg-kaleo-earth transition-colors duration-300 shadow-lg"
          >
            Agenda tu Consulta Gratuita
          </a>
          <a
            href="#nosotras"
            className="px-8 py-4 border-2 border-kaleo-cream/50 text-kaleo-cream font-body text-sm uppercase tracking-wider rounded-full hover:bg-kaleo-cream/10 hover:border-kaleo-cream transition-all duration-300"
          >
            Conócenos
          </a>
        </div>
